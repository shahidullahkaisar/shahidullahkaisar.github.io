...
/* ══ ✏️ YOUR BRAND + NAME ══ */
const BRAND   = "Kaiserism";            // the wordmark shown top-left on every page
const MY_NAME = "Shahidullah Kaisar";   // your real name (used in the footer)
...
(function(){
  ...
  nav.innerHTML = `<div class="nav-in">
      <a class="nav-name" href="${pre}index.html" title="${MY_NAME}">
        <span class="brand">${BRAND}</span><span class="dot"></span>
      </a>
      <div class="nav-links">
  ...
  f.innerHTML = `<div class="wrap">
      ...
      <div class="f-end">
        <span>© ${new Date().getFullYear()} ${MY_NAME} · Kaiserism</span>
